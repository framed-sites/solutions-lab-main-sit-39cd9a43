    ...
    <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container mx-auto flex h-16 items-center justify-between px-4 md:px-6">
        ...
        <nav className="hidden md:flex items-center gap-6">
          ...
          <Link to="/solutions" className="text-sm font-medium text-foreground/80 hover:text-primary transition-colors">Solutions</Link>
        ...
        <Sheet>
          ...
          <SheetContent side="right">
            <SheetHeader>
              <SheetTitle>Solutions Lab</SheetTitle>
            </SheetHeader>
            <nav className="mt-6 flex flex-col space-y-1">
              ...
              <Link to="/solutions" className="block px-3 py-2 text-base font-medium text-foreground/80 hover:text-primary transition-colors">Solutions</Link>
